...
const projectsData = [
  {
    ...
    description: "A Vel Tech institutional portal with role-based authentication, attendance calculations, faculty management, analytics, and automated PDF reports.",
    tags: ["HTML5", "CSS3", "JavaScript", "Role Auth", "jsPDF"],
    match: "99%",
    episode: "S01 E01"
  },
  {
    ...
    description: "A responsive e-commerce application with product catalog filtering, instant search, cart state management, promotional banners, rewards, and delivery checking.",
    tags: ["HTML5", "CSS3", "JavaScript", "UI/UX", "GitHub Pages"],
    match: "98%",
    episode: "S01 E02"
  },
  {
    title: "Interactive AI Developer Portfolio",
    category: "Personal Brand & Web",
    description: "A responsive developer portfolio with glassmorphism UI, credential filtering, interactive modals, theme controls, and GitHub Pages deployment.",
    tags: ["HTML5", "CSS3", "JavaScript", "UI", "GitHub Pages"],
    match: "99%",
    episode: "S01 E03"
  },
  {
    ...
    description: "A Python voice assistant using speech recognition, text-to-speech, NLP, web search, and desktop automation workflows.",
  ...
  },
  {
    ...
    description: "An academic support chatbot designed to answer student questions about courses, schedules, fees, and department information.",
    tags: ["Python", "NLP", "JSON", "Rule Engine"],
    match: "96%",
    episode: "S01 E05"
  },
  {
    ...
    description: "A supervised machine learning project using preprocessing, feature analysis, visualization, and Scikit-Learn classification techniques.",
  ...
  },
  {
    ...
    description: "A regression-based machine learning model for estimating housing prices from real-estate and structural features.",
    tags: ["Python", "Linear Regression", "Pandas", "Scikit-Learn"],
    match: "97%",
    episode: "S01 E07"
  },
  {
    ...
    description: "A Jupyter Notebook project for exploratory data analysis, statistical summaries, data cleaning, and visualization using Python data-science libraries.",
  ...
  },
  {
    ...
    description: "A campus event platform for scheduling, student registration, automated email receipts, and administrative analytics.",
    tags: ["Java", "Spring Boot", "MySQL", "JPA", "Thymeleaf"],
    match: "99%",
    episode: "S01 E09"
  }
];
